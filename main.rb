...
# words.each do |var|
# 
# p eval("%w[ant bear cat].my_#{var}? { |word| word.length >= 3 } == %w[ant bear cat].#{var}? { |word| word.length >= 3 }")
# p eval("%w[ant bear cat].my_#{var}? { |word| word.length >= 4 } == %w[ant bear cat].#{var}? { |word| word.length >= 4 }")
# p eval("%w[ant bear cat].my_#{var}?(/d/)                        == %w[ant bear cat].#{var}?(/d/)                       ")
